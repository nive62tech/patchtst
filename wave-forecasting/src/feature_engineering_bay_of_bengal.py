"""
Phase 3 (Bay of Bengal) - Feature Engineering (Direction Encoding)

Loads bay_of_bengal/data/bay_of_bengal_clean.csv, applies sin/cos circular encoding to
mwd (Formula 3), keeps a copy of raw mwd in the file for later use as a
Phase 5 forecasting target, and saves bay_of_bengal/data/bay_of_bengal_features.csv.
...
Mirrors src/feature_engineering.py (Atlantic) exactly, renamed for Bay of Bengal.
"""
...
INPUT_PATH = DATA_DIR / "bay_of_bengal_clean.csv"
OUTPUT_PATH = DATA_DIR / "bay_of_bengal_features.csv"
...
def main():
    print("=" * 60)
    print("PHASE 3 (BAY OF BENGAL) - FEATURE ENGINEERING (DIRECTION ENCODING)")
    print("=" * 60)

    if not INPUT_PATH.exists():
        raise FileNotFoundError(f"{INPUT_PATH} not found - run Bay of Bengal Phase 2 first.")
