"""
Phase 6 (Bay of Bengal) - Train/Test Split - 70/30 by Date

Loads bay_of_bengal/data/bay_of_bengal_features.csv, computes a strict
chronological 70/30 split (no shuffling), and saves
bay_of_bengal_train.csv / bay_of_bengal_test.csv.

Mirrors src/split.py (Atlantic) exactly, renamed for Bay of Bengal.
"""
...
TRAIN_OUTPUT_PATH = DATA_DIR / "bay_of_bengal_train.csv"
TEST_OUTPUT_PATH = DATA_DIR / "bay_of_bengal_test.csv"
...
def main():
    print("=" * 60)
    print("PHASE 6 (BAY OF BENGAL) - TRAIN/TEST SPLIT (70/30 BY DATE)")
    print("=" * 60)

    if not INPUT_PATH.exists():
        raise FileNotFoundError(f"{INPUT_PATH} not found - run Bay of Bengal Phase 5 first.")
