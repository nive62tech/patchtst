...
Mirrors src/windowing.py (Atlantic) exactly, renamed for Pacific.
"""
...
TRAIN_PATH = DATA_DIR / "pacific_train_scaled.csv"
TEST_PATH = DATA_DIR / "pacific_test_scaled.csv"
...
def main():
    print("=" * 60)
    print("PHASE 8 (PACIFIC) - SEQUENCE WINDOWING")
    print("=" * 60)

    if not TRAIN_PATH.exists() or not TEST_PATH.exists():
        raise FileNotFoundError(
            "pacific_train_scaled.csv / pacific_test_scaled.csv not found - run Pacific Phase 7 first."
        )
