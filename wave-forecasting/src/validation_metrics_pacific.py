...
Loads the best checkpoint, runs inference on the full Pacific test set,
...
Saves: pacific/results/validation_metrics.json
       pacific/results/validation_metrics_table.md
"""
...
SCALER_PATH = PACIFIC_DIR / "scaler_pacific.pkl"
...
def main():
    ...
    table_md = (
        "# Extended Validation Metrics — Pacific\n\n"
        "Computed in real units (inverse-transformed via scaler_pacific.pkl), "
    ...
    print("\n[OK] Extended validation metrics complete for Pacific.")
