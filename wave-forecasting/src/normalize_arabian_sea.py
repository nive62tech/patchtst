"""
Phase 7 (Arabian Sea) - Normalization

Fits a StandardScaler on the training set only (arabian_sea_train.csv),
applies it to both arabian_sea_train.csv and arabian_sea_test.csv, and
saves the fitted scaler as arabian_sea/scaler_arabian_sea.pkl.
...
Mirrors src/normalize.py (Atlantic) exactly, renamed for Arabian Sea.
"""
...
DATA_DIR = Path(__file__).resolve().parent.parent / "arabian_sea" / "data"
SEA_DIR = Path(__file__).resolve().parent.parent / "arabian_sea"

TRAIN_PATH = DATA_DIR / "arabian_sea_train.csv"
TEST_PATH = DATA_DIR / "arabian_sea_test.csv"
TRAIN_OUTPUT_PATH = DATA_DIR / "arabian_sea_train_scaled.csv"
TEST_OUTPUT_PATH = DATA_DIR / "arabian_sea_test_scaled.csv"
SCALER_OUTPUT_PATH = SEA_DIR / "scaler_arabian_sea.pkl"
...
def main():
    print("=" * 60)
    print("PHASE 7 (ARABIAN SEA) - NORMALIZATION")
    print("=" * 60)

    if not TRAIN_PATH.exists() or not TEST_PATH.exists():
        raise FileNotFoundError(
            "arabian_sea_train.csv / arabian_sea_test.csv not found - run Arabian Sea Phase 6 first."
        )
