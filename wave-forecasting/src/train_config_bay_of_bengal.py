"""
Phase 10 (Bay of Bengal) - Training Setup
...
tiny slice of real Bay of Bengal windowed data.

Mirrors src/train_config.py (Atlantic) exactly, renamed for Bay of Bengal.
"""
...
def main():
    print("=" * 60)
    print("PHASE 10 (BAY OF BENGAL) - TRAINING SETUP")
    print("=" * 60)

    if not (WINDOWS_DIR / "y_class_train.npy").exists():
        raise FileNotFoundError("Bay of Bengal Phase 8 windowed arrays not found - run Bay of Bengal Phase 8 first.")
    ...
    print("\n--- Local smoke test (CPU, tiny batch, real Bay of Bengal data - not full training) ---")
    ...
    print("[OK] One optimizer step completed successfully on real Bay of Bengal data")
    ...
    print("\n[OK] Training setup verified for Bay of Bengal. Ready for Phase 11 (Colab GPU training).")
