"""
Phase 4 (Arabian Sea) - Label Definition (Classification Target)

Loads arabian_sea/data/arabian_sea_features.csv, computes Arabian Sea's OWN
...
CONFIRMED and hardcoded for all future Arabian Sea runs.
"""
...
INPUT_PATH = DATA_DIR / "arabian_sea_features.csv"
OUTPUT_PATH = DATA_DIR / "arabian_sea_features.csv"  # same file, mwp_class column added
...
def main():
    print("=" * 60)
    print("PHASE 4 (ARABIAN SEA) - LABEL DEFINITION (CLASSIFICATION TARGET)")
    print("=" * 60)

    if not INPUT_PATH.exists():
        raise FileNotFoundError(f"{INPUT_PATH} not found - run Arabian Sea Phase 3 first.")
    ...
    print("\n--- Computing Arabian Sea's OWN quartile bin edges ---")
