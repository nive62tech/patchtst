"""
Phase 11 (Bay of Bengal) - Model Training

Core training loop for the PatchTST dual-head model on Bay of Bengal data.
Mirrors src/train.py (Atlantic) exactly, renamed for Bay of Bengal. Designed
to be imported both locally (quick CPU sanity check) and inside the Colab
notebook (notebooks/colab_train_bay_of_bengal.ipynb) for the actual full
training run on GPU.
"""
...
from src.train_config_bay_of_bengal import (
    JointLoss,
...
if __name__ == "__main__":
    print("=" * 60)
    print("PHASE 11 (BAY OF BENGAL) - LOCAL SANITY CHECK (2 epochs, CPU)")
    print("=" * 60)
