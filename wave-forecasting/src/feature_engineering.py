...
Loads atlantic/data/atlantic_clean.csv, applies sin/cos circular encoding to
mwd (Formula 3), keeps a copy of raw mwd in the file for later use as a
Phase 5 forecasting target, and saves atlantic/data/atlantic_features.csv.
...
INPUT_PATH = DATA_DIR / "atlantic_clean.csv"
OUTPUT_PATH = DATA_DIR / "atlantic_features.csv"
...
def main():
    print("=" * 60)
    print("PHASE 3 - FEATURE ENGINEERING (DIRECTION ENCODING)")
    print("=" * 60)
    ...
    # Sanity check: sin^2 + cos^2 should equal 1.0 for every row
