"""
Phase 2 (Arabian Sea) - Data Cleaning

Loads arabian_sea/data/arabian_sea_merged.csv, finds missing timestamps by comparing
...
gaps, removes duplicate timestamps, and saves arabian_sea/data/arabian_sea_clean.csv.

Mirrors src/data_cleaning.py (Atlantic) exactly, renamed for Arabian Sea.
"""
...
INPUT_PATH = DATA_DIR / "arabian_sea_merged.csv"
OUTPUT_PATH = DATA_DIR / "arabian_sea_clean.csv"
...
def main():
    print("=" * 60)
    print("PHASE 2 (ARABIAN SEA) - DATA CLEANING")
    print("=" * 60)

    if not INPUT_PATH.exists():
        raise FileNotFoundError(f"{INPUT_PATH} not found - run Arabian Sea Phase 1 first.")
