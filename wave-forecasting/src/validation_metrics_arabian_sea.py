"""
Extended Validation Metrics - Arabian Sea

Loads the best checkpoint, runs inference on the full Arabian Sea test set,
...
Saves: arabian_sea/results/validation_metrics.json
...
SCALER_PATH = SEA_DIR / "scaler_arabian_sea.pkl"
...
def main():
    print("=" * 60)
    print("EXTENDED VALIDATION METRICS - ARABIAN SEA")
    print("=" * 60)
    ...
    table_md = (
        "# Extended Validation Metrics — Arabian Sea\n\n"
        "Computed in real units (inverse-transformed via scaler_arabian_sea.pkl), "
    ...
    print("\n[OK] Extended validation metrics complete for Arabian Sea.")
