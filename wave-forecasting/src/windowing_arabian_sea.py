...
Mirrors src/windowing.py (Atlantic) exactly, renamed for Arabian Sea.
"""
...
TRAIN_PATH = DATA_DIR / "arabian_sea_train_scaled.csv"
TEST_PATH = DATA_DIR / "arabian_sea_test_scaled.csv"
...
def main():
    print("=" * 60)
    print("PHASE 8 (ARABIAN SEA) - SEQUENCE WINDOWING")
    print("=" * 60)

    if not TRAIN_PATH.exists() or not TEST_PATH.exists():
        raise FileNotFoundError(
            "arabian_sea_train_scaled.csv / arabian_sea_test_scaled.csv not found - run Arabian Sea Phase 7 first."
        )
