"""
Phase 15 (Bay of Bengal) - Combined Results Dashboard
...
Saves: bay_of_bengal/results/results_dashboard.png
"""
...
def main():
    print("=" * 60)
    print("PHASE 15 (BAY OF BENGAL) - COMBINED RESULTS DASHBOARD")
    print("=" * 60)
    ...
    fig.suptitle("Bay of Bengal - PatchTST Evaluation Results", fontsize=15, fontweight="bold")
