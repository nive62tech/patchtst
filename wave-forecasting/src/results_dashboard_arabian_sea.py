"""
Phase 15 (Arabian Sea) - Combined Results Dashboard
...
Saves: arabian_sea/results/results_dashboard.png
"""
...
def main():
    print("=" * 60)
    print("PHASE 15 (ARABIAN SEA) - COMBINED RESULTS DASHBOARD")
    print("=" * 60)
    ...
    fig.suptitle("Arabian Sea - PatchTST Evaluation Results", fontsize=15, fontweight="bold")
