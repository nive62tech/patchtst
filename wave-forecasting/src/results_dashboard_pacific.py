"""
Phase 15 (Pacific) - Combined Results Dashboard
...
Saves: pacific/results/results_dashboard.png
"""
...
def main():
    ...
    fig.suptitle("Pacific - PatchTST Evaluation Results", fontsize=15, fontweight="bold")
