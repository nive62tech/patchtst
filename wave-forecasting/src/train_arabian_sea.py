"""
Phase 11 (Arabian Sea) - Model Training

Core training loop for the PatchTST dual-head model on Arabian Sea data.
Mirrors src/train.py (Atlantic) exactly, renamed for Arabian Sea. Designed
to be imported both locally (quick CPU sanity check) and inside the Colab
notebook (notebooks/colab_train_arabian_sea.ipynb) for the actual full
training run on GPU.
"""
...
from src.train_config_arabian_sea import (
    JointLoss,
...
if __name__ == "__main__":
    print("=" * 60)
    print("PHASE 11 (ARABIAN SEA) - LOCAL SANITY CHECK (2 epochs, CPU)")
    print("=" * 60)
