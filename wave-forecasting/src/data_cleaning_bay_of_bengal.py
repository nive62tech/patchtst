"""
Phase 2 (Bay of Bengal) - Data Cleaning

Loads bay_of_bengal/data/bay_of_bengal_merged.csv, finds missing timestamps by comparing
...
gaps, removes duplicate timestamps, and saves bay_of_bengal/data/bay_of_bengal_clean.csv.

Mirrors src/data_cleaning.py (Atlantic) exactly, renamed for Bay of Bengal.
"""
...
INPUT_PATH = DATA_DIR / "bay_of_bengal_merged.csv"
OUTPUT_PATH = DATA_DIR / "bay_of_bengal_clean.csv"
...
def main():
    print("=" * 60)
    print("PHASE 2 (BAY OF BENGAL) - DATA CLEANING")
    print("=" * 60)

    if not INPUT_PATH.exists():
        raise FileNotFoundError(f"{INPUT_PATH} not found - run Bay of Bengal Phase 1 first.")
