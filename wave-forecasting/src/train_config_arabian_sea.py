"""
Phase 10 (Arabian Sea) - Training Setup
...
tiny slice of real Arabian Sea windowed data.

Mirrors src/train_config.py (Atlantic) exactly, renamed for Arabian Sea.
"""
...
def main():
    print("=" * 60)
    print("PHASE 10 (ARABIAN SEA) - TRAINING SETUP")
    print("=" * 60)

    if not (WINDOWS_DIR / "y_class_train.npy").exists():
        raise FileNotFoundError("Arabian Sea Phase 8 windowed arrays not found - run Arabian Sea Phase 8 first.")
    ...
    print("\n--- Local smoke test (CPU, tiny batch, real Arabian Sea data - not full training) ---")
    ...
    print("[OK] One optimizer step completed successfully on real Arabian Sea data")
    ...
    print("\n[OK] Training setup verified for Arabian Sea. Ready for Phase 11 (Colab GPU training).")
