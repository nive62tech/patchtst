"""
Phase 8 (Bay of Bengal) - Sequence Windowing

Builds 72-hour input windows and matching classification/forecasting targets,
separately within bay_of_bengal_train_scaled.csv and bay_of_bengal_test_scaled.csv -
windows never span the train/test boundary. Saves the resulting numpy arrays
under bay_of_bengal/data/windows/.
...
Mirrors src/windowing.py (Atlantic) exactly, renamed for Bay of Bengal.
"""
...
TRAIN_PATH = DATA_DIR / "bay_of_bengal_train_scaled.csv"
TEST_PATH = DATA_DIR / "bay_of_bengal_test_scaled.csv"
...
def main():
    print("=" * 60)
    print("PHASE 8 (BAY OF BENGAL) - SEQUENCE WINDOWING")
    print("=" * 60)

    if not TRAIN_PATH.exists() or not TEST_PATH.exists():
        raise FileNotFoundError(
            "bay_of_bengal_train_scaled.csv / bay_of_bengal_test_scaled.csv not found - run Bay of Bengal Phase 7 first."
        )
